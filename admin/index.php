...
<body>
    <header>
        <h1>Zone admin</h1>
        <p>
            <a class="ajouter" href="ajouter.php"> Ajouter un repas</a>
        </p>
    </header>
    <main>
        ...
        <div class="les_repas">
            ...
            <?php foreach ($les_repas as $un_repas): ?>
                <div class="un_repas">
                    ...
                    <a class="modifier" href="modifier.php?id=<?= $un_repas['id']?>">Modifier</a>
                    <a class="supprimer" href="index.php?supprimer=<?= $un_repas['id']?>">Supprimer</a>
                </div>
            <?php endforeach?>
        </div>
    </main>
